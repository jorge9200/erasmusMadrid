...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2015 a las 17:08:05
...
INSERT INTO `user` (`id_user`, `name_user`, `password`, `email`, `date_birth`) VALUES
(1, 'a', 'a', 'a@gg.com', '26/01/1991');
...
ALTER TABLE `user_event`
 ADD KEY `id_user` (`id_user`,`id_event`), ADD KEY `id_event` (`id_event`);
...
--
ALTER TABLE `user_event`
ADD CONSTRAINT `event_restriction` FOREIGN KEY (`id_event`) REFERENCES `event` (`id_event`) ON UPDATE CASCADE,
ADD CONSTRAINT `user_restriction` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON UPDATE CASCADE;
